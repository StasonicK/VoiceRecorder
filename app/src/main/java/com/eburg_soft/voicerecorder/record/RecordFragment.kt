package com.eburg_soft.voicerecorder.record
...
import com.eburg_soft.voicerecorder.MainActivity
...
import com.eburg_soft.voicerecorder.databinding.FragmentRecordBinding
...
class RecordFragment : Fragment() {
    ...
    private fun onRecord(start: Boolean) {
        ...
        if (start) {
            ...
            playButton.setImageResource(R.drawable.ic_mic_white_36)
